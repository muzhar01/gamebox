            ...
            <div class="page-body">
                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        <div class="row">
                            <div class="col-md-8">
                                <form id="setLogoForm" action="{{ route('admin.settings.set_background_image') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="background-image-preview">
                                    @if ($backgroundImage !== null)
                                        <img class="img-thumbnail" src="{{ asset('/storage/background/'. $backgroundImage->value) }}" alt="" style="margin: auto; display: block; height: 180px; width: 180px;"> 
                                    @else
                                        <img class="img-thumbnail" style="margin: auto; display: block; height: 180px; width: 180px;" src="data:image/png;base64," alt="">
                                    @endif
                                </div>
