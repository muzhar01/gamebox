                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <!-- for arabic -->
                                            <div dir="rtl">
                                                <div class="form-group row arabicTitle"><div class="col-sm-6" dir="rtl"><label for="">عنوان</label><input type="text" name="ar_title" class="form-control" value="{{ old('ar_title') ?? $page->ar_title ?? '' }}" placeholder="أدخل العنوان"></div></div>
                                                <div class="form-group row arabicContent"><div class="col-sm-12" dir="rtl"><label for="">محتوى الصفحة</label><textarea name="ar_content" class="form-control" placeholder="كتابة أو لصق محتوى الصفحة">{{ old('ar_content') ?? $page->content ?? '' }}</textarea></div></div>
                                            </div>
                                            <!-- // for arabic -->
                                            <div class="mt-3">
