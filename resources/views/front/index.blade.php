    ...
    <div class="game-container">
                        ...
                        <div class="grid-item item-grid item shadow mb-2">
                            ...
                            @endauth
                                <div class="list-game">
                                    ...
                                    <div class="font-weight-light text-center text-dark">{{ $new_game->title }}</div>
                                </div>
                            </a>
                        </div>
                    @endforeach
                        ...
                        <div class="grid-item item-grid item shadow mb-2">
                            <a href="{{ route('home.play', $papular_game->id) }}">
                                <div class="list-game">
                                    ...
                                    {{-- <div class="list-title"><span class="btn btn-sm btn-outline-success">Play Now</span></div> --}}
                                    <div class="font-weight-light text-center text-dark">{{ $papular_game->title }}</div>
                                </div>
                            </a>
                        </div>
                    @endforeach
        ...
        @foreach($cat_games as $category)
            <div class="row mb-3 text-dark">
                ...
                <div class="col-1">
                    <a href="{{ route('home.category', ($category->id ?? 0)) }}" class="text-dark"><h3 class="h4 text-right"><i class="fa fa-arrow-right {{ $lang && $lang == 'ar' ? 'fa-flip-horizontal' : '' }}" aria-hidden="true"></i></h3></a>
                </div>
            </div>
                            ...
                            <div class="grid-item item-grid item shadow mb-2">
                                <a href="{{ route('home.play', $game->id) }}">
                                    <div class="list-game">
                                        ...
                                        {{-- <div class="list-title"><span class="btn btn-sm btn-outline-success">Play Now</span></div> --}}
                                        <div class="font-weight-light text-center text-dark">{{ $game->title }}</div>
                                    </div>
                                </a>
                            </div>
                        @endforeach
